    ...
    this.echartsOptions = {
      ...
      tooltip: {
        ...
        formatter: (params: any) => {
          return `
          <span class='text-[12.112px] text-[#E5E5EF]'>${
            params[0].data
          } usages</span><br>
                  <span class='flex items-center me-1 text-[8.074px] text-mainColor font-medium'><svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9" fill="none">
                  ...
                  </svg><span> % ${(params[0].data * 0.1).toFixed(
                    2
                  )}</span> </span>`;
        },
        borderRadius: 8,
